...
impl mydsp {
    ...
    #[allow(non_snake_case)]
    #[inline(never)]
    fn karplus_faust(&mut self, count: i32, inputs: &[&[F32]], outputs: &mut [&mut [F32]]) {
        ...
        for (output0, output1) in zipped_iterators {
            ...
            self.fVec0[0] = fSlow2;
            self.fRec2[0] = self.fRec2[1] + ((fSlow2 - self.fVec0[1]) > 0.0) as u32 as F32
                - fSlow1 * (self.fRec2[1] > 0.0) as u32 as F32;
            let mut fTemp0: F32 = fSlow3
                * ((self.fRec2[0] > 0.0) as u32 as F32 + 1.5258789e-05)
                * (self.iRec1[0]) as F32;
            ...
            self.fVec8[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec9[1] + self.fRec9[2]);
            self.fRec9[0] = self.fVec8[((i32::wrapping_sub(self.IOTA0, iSlow21)) & 4095) as usize];
            self.fVec9[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec10[1] + self.fRec10[2]);
            self.fRec10[0] = self.fVec9[((i32::wrapping_sub(self.IOTA0, iSlow23)) & 4095) as usize];
            self.fVec10[(self.IOTA0 & 2047) as usize] =
                fTemp0 + fSlow0 * (self.fRec11[1] + self.fRec11[2]);
            self.fRec11[0] =
                self.fVec10[((i32::wrapping_sub(self.IOTA0, iSlow25)) & 2047) as usize];
            self.fVec11[(self.IOTA0 & 511) as usize] =
                fSlow0 * (self.fRec12[1] + self.fRec12[2]) + fTemp0;
            self.fRec12[0] = self.fVec11[((i32::wrapping_sub(self.IOTA0, iSlow27)) & 511) as usize];
            self.fVec12[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec13[1] + self.fRec13[2]);
            self.fRec13[0] =
                self.fVec12[((i32::wrapping_sub(self.IOTA0, iSlow29)) & 4095) as usize];
            self.fVec13[(self.IOTA0 & 8191) as usize] =
                fTemp0 + fSlow0 * (self.fRec14[1] + self.fRec14[2]);
            self.fRec14[0] =
                self.fVec13[((i32::wrapping_sub(self.IOTA0, iSlow31)) & 8191) as usize];
            self.fVec14[(self.IOTA0 & 8191) as usize] =
                fTemp0 + fSlow0 * (self.fRec15[1] + self.fRec15[2]);
            self.fRec15[0] =
                self.fVec14[((i32::wrapping_sub(self.IOTA0, iSlow33)) & 8191) as usize];
            ...
            *output0 = fSlow39
            ...
            self.fVec24[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec25[1] + self.fRec25[2]);
            self.fRec25[0] =
                self.fVec24[((i32::wrapping_sub(self.IOTA0, iSlow54)) & 4095) as usize];
            self.fVec25[(self.IOTA0 & 4095) as usize] =
                fTemp0 + fSlow0 * (self.fRec26[1] + self.fRec26[2]);
            self.fRec26[0] =
                self.fVec25[((i32::wrapping_sub(self.IOTA0, iSlow56)) & 4095) as usize];
            self.fVec26[(self.IOTA0 & 2047) as usize] =
                fTemp0 + fSlow0 * (self.fRec27[1] + self.fRec27[2]);
            self.fRec27[0] =
                self.fVec26[((i32::wrapping_sub(self.IOTA0, iSlow58)) & 2047) as usize];
            self.fVec27[(self.IOTA0 & 1023) as usize] =
                fTemp0 + fSlow0 * (self.fRec28[1] + self.fRec28[2]);
            self.fRec28[0] =
                self.fVec27[((i32::wrapping_sub(self.IOTA0, iSlow60)) & 1023) as usize];
            self.fVec28[(self.IOTA0 & 1023) as usize] =
                fTemp0 + fSlow0 * (self.fRec29[1] + self.fRec29[2]);
            self.fRec29[0] =
                self.fVec28[((i32::wrapping_sub(self.IOTA0, iSlow62)) & 1023) as usize];
...
impl mydsp_vec {
    ...
    #[allow(unused_mut)]
    #[inline(never)]
    fn karplus_faust_vec<const CHUNK_SIZE: i32>(
        &mut self,
        count: i32,
        inputs: &[&[F32]],
        outputs: &mut [&mut [F32]],
    ) {
        let [output0_ptr, output1_ptr] = outputs else {
            panic!("Expected 2 outputs");
        };
        let mut fSlow0: F32 = 1.0 / self.fHslider0;
        let mut fSlow1: F32 = self.fButton0;
        let mut fVec0_tmp: [F32; 36] = [0.0; 36];
        let mut fRec1_tmp: [F32; 36] = [0.0; 36];
        let mut iRec2_tmp: [i32; 36] = [0; 36];
        ...
        let mut iSlow13: i32 = (F32::min(4096.0, F32::max(0.0, fSlow5 + -1.5))) as i32;
        ...
        let mut fSlow23: F32 = (fSlow22 > 3e+01) as u32 as F32;
        let mut fSlow24: F32 = (fSlow22 > 28.0) as u32 as F32;
        let mut fSlow25: F32 = (fSlow22 > 22.0) as u32 as F32;
        let mut fSlow26: F32 = (fSlow22 > 16.0) as u32 as F32;
        let mut fSlow27: F32 = (fSlow22 > 14.0) as u32 as F32;
        let mut fSlow28: F32 = (fSlow22 > 1e+01) as u32 as F32;
        let mut fSlow29: F32 = (fSlow22 > 4.0) as u32 as F32;
        let mut fSlow30: F32 = (fSlow22 > 2.0) as u32 as F32;
        let mut fSlow31: F32 = (fSlow22 > 0.0) as u32 as F32;
        let mut fSlow32: F32 = (fSlow22 > 8.0) as u32 as F32;
        let mut fSlow33: F32 = (fSlow22 > 6.0) as u32 as F32;
        let mut fSlow34: F32 = (fSlow22 > 12.0) as u32 as F32;
        let mut fSlow35: F32 = (fSlow22 > 18.0) as u32 as F32;
        let mut fSlow36: F32 = (fSlow22 > 2e+01) as u32 as F32;
        let mut fSlow37: F32 = (fSlow22 > 24.0) as u32 as F32;
        let mut fSlow38: F32 = (fSlow22 > 26.0) as u32 as F32;
        let mut fSlow39: F32 = self.fHslider6;
        let mut iSlow40: i32 =
            (F32::min(4096.0, F32::max(0.0, fSlow5 + 25.0 * fSlow4 + -1.5))) as i32;
        ...
        let mut iSlow48: i32 =
            (F32::min(4096.0, F32::max(0.0, fSlow5 + 3.0 * fSlow4 + -1.5))) as i32;
        let mut fRec26_tmp: [F32; 36] = [0.0; 36];
        let mut iSlow49: i32 = (F32::min(4096.0, F32::max(0.0, fSlow4 + fSlow5 + -1.5))) as i32;
        ...
        let mut fSlow56: F32 = (fSlow22 > 31.0) as u32 as F32;
        let mut fSlow57: F32 = (fSlow22 > 29.0) as u32 as F32;
        let mut fSlow58: F32 = (fSlow22 > 23.0) as u32 as F32;
        let mut fSlow59: F32 = (fSlow22 > 17.0) as u32 as F32;
        let mut fSlow60: F32 = (fSlow22 > 11.0) as u32 as F32;
        let mut fSlow61: F32 = (fSlow22 > 5.0) as u32 as F32;
        let mut fSlow62: F32 = (fSlow22 > 1.0) as u32 as F32;
        let mut fSlow63: F32 = (fSlow22 > 3.0) as u32 as F32;
        let mut fSlow64: F32 = (fSlow22 > 9.0) as u32 as F32;
        let mut fSlow65: F32 = (fSlow22 > 7.0) as u32 as F32;
        let mut fSlow66: F32 = (fSlow22 > 13.0) as u32 as F32;
        let mut fSlow67: F32 = (fSlow22 > 15.0) as u32 as F32;
        let mut fSlow68: F32 = (fSlow22 > 21.0) as u32 as F32;
        let mut fSlow69: F32 = (fSlow22 > 19.0) as u32 as F32;
        let mut fSlow70: F32 = (fSlow22 > 27.0) as u32 as F32;
        let mut fSlow71: F32 = (fSlow22 > 25.0) as u32 as F32;
        ...
        for vindex in (0..=i32::wrapping_sub(count, CHUNK_SIZE)).step_by(CHUNK_SIZE as usize) {
            ...
            for i in 0..vsize {
                fZec0[i as usize] = fSlow3
                    * ((fRec1_tmp[(i32::wrapping_add(4, i)) as usize] > 0.0) as u32 as F32
                        + 1.5258789e-05)
            ...
            /* Recursive loop 13 */
            /* Pre code */
            self.fYec22_idx = (i32::wrapping_add(self.fYec22_idx, self.fYec22_idx_save)) & 8191;
            for j50 in 0..4 {
                fRec24_tmp[j50 as usize] = self.fRec24_perm[j50 as usize];
            }
            /* Compute code */
            for i in 0..vsize {
                self.fYec22[((i32::wrapping_add(i, self.fYec22_idx)) & 8191) as usize] = fZec0
                    [i as usize]
                    + fSlow2
            ...
            /* Recursive loop 14 */
            /* Pre code */
            self.fYec23_idx = (i32::wrapping_add(self.fYec23_idx, self.fYec23_idx_save)) & 8191;
            for j52 in 0..4 {
                fRec25_tmp[j52 as usize] = self.fRec25_perm[j52 as usize];
            }
            /* Compute code */
            for i in 0..vsize {
                self.fYec23[((i32::wrapping_add(i, self.fYec23_idx)) & 8191) as usize] = fZec0
                    [i as usize]
                    + fSlow2
            ...
            /* Recursive loop 15 */
            /* Pre code */
            self.fYec24_idx = (i32::wrapping_add(self.fYec24_idx, self.fYec24_idx_save)) & 4095;
            for j54 in 0..4 {
                fRec26_tmp[j54 as usize] = self.fRec26_perm[j54 as usize];
            }
            /* Compute code */
            for i in 0..vsize {
                self.fYec24[((i32::wrapping_add(i, self.fYec24_idx)) & 4095) as usize] = fZec0
                    [i as usize]
                    + fSlow2
            ...
            /* Recursive loop 17 */
            /* Pre code */
            self.fYec7_idx = (i32::wrapping_add(self.fYec7_idx, self.fYec7_idx_save)) & 1023;
            for j20 in 0..4 {
                fRec9_tmp[j20 as usize] = self.fRec9_perm[j20 as usize];
            }
            /* Compute code */
            for i in 0..vsize {
                self.fYec7[((i32::wrapping_add(i, self.fYec7_idx)) & 1023) as usize] = fSlow2
            ...
            /* Compute code */
            for i in 0..vsize {
                self.fYec9[((i32::wrapping_add(i, self.fYec9_idx)) & 4095) as usize] = fZec0
                    [i as usize]
                    + fSlow2
            ...
            /* Recursive loop 21 */
            /* Pre code */
            self.fYec8_idx = (i32::wrapping_add(self.fYec8_idx, self.fYec8_idx_save)) & 2047;
            for j22 in 0..4 {
                fRec10_tmp[j22 as usize] = self.fRec10_perm[j22 as usize];
            }
            /* Compute code */
            for i in 0..vsize {
                self.fYec8[((i32::wrapping_add(i, self.fYec8_idx)) & 2047) as usize] = fZec0
                    [i as usize]
                    + fSlow2
            ...
            /* Recursive loop 30 */
            /* Pre code */
            self.fYec25_idx = (i32::wrapping_add(self.fYec25_idx, self.fYec25_idx_save)) & 2047;
            for j56 in 0..4 {
                fRec27_tmp[j56 as usize] = self.fRec27_perm[j56 as usize];
            }
            /* Compute code */
            for i in 0..vsize {
                self.fYec25[((i32::wrapping_add(i, self.fYec25_idx)) & 2047) as usize] = fZec0
                    [i as usize]
                    + fSlow2
            ...
            /* Recursive loop 33 */
            /* Pre code */
            self.fYec26_idx = (i32::wrapping_add(self.fYec26_idx, self.fYec26_idx_save)) & 4095;
            for j58 in 0..4 {
                fRec28_tmp[j58 as usize] = self.fRec28_perm[j58 as usize];
            }
            /* Compute code */
            for i in 0..vsize {
                self.fYec26[((i32::wrapping_add(i, self.fYec26_idx)) & 4095) as usize] = fZec0
                    [i as usize]
                    + fSlow2
            ...
            /* Compute code */
            for i in 0..vsize {
                output0_ptr[(i32::wrapping_add(vindex, i)) as usize] = fSlow39
            ...
            /* Compute code */
            for i in 0..vsize {
                output1_ptr[(i32::wrapping_add(vindex, i)) as usize] = fSlow39
...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    group.bench_function("faust_single", |b| {
        b.iter(|| {
            black_box(mydsp::karplus_faust(
                black_box(&mut dsp),
    ...
    let mut dsp_vec = mydsp_vec::default_boxed();

    for chunk_size in [4, 8, 16, 32] {
        group.bench_with_input("faust_vec", &chunk_size, |b, &s| match s {
            4 => black_box(mydsp_vec::karplus_faust_vec::<4>(
                black_box(&mut dsp_vec),
                black_box(SIZE as i32),
                black_box(&[]),
                black_box(&mut [&mut buf0, &mut buf1]),
            )),
            8 => black_box(mydsp_vec::karplus_faust_vec::<8>(
                black_box(&mut dsp_vec),
                black_box(SIZE as i32),
                black_box(&[]),
                black_box(&mut [&mut buf0, &mut buf1]),
            )),
            16 => black_box(mydsp_vec::karplus_faust_vec::<16>(
                black_box(&mut dsp_vec),
                black_box(SIZE as i32),
                black_box(&[]),
                black_box(&mut [&mut buf0, &mut buf1]),
            )),
            32 => black_box(mydsp_vec::karplus_faust_vec::<32>(
                black_box(&mut dsp_vec),
                black_box(SIZE as i32),
                black_box(&[]),
                black_box(&mut [&mut buf0, &mut buf1]),
